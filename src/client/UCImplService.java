 ...
 * 
 */
@WebServiceClient(name = "UCImplService", targetNamespace = "http://uc.java.ca.UC/", wsdlLocation = "http://localhost:9901/UC?wsdl")
public class UCImplService extends Service
{
    ...
    private final static QName UCIMPLSERVICE_QNAME = new QName("http://uc.java.ca.UC/", "UCImplService");
    ...
    public UCImplService() {
        super(__getWsdlLocation(), UCIMPLSERVICE_QNAME);    //Service service=Service.create(url,qname);
    }
    ...
    public UC getUCImplPort() {
        return super.getPort(new QName("http://uc.java.ca.UC/", "UCImplPort"), UC.class); //UC uc=service.getPort(qname,UC.class);
    }
    ...
    public UC getUCImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://uc.java.ca.UC/", "UCImplPort"), UC.class, features);
    }
